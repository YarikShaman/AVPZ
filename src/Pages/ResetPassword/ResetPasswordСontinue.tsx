...
function ResetPasswordContinue() {
    ...
    function PasswordChangeDestribution(){
        if(isFromProfile){
            PasswordChange2();
        } else{
            PasswordChange();
    ...
    function PasswordChange2(){
        if(errorPassword1=="" && errorPassword2=="" && errorPasswordOld==""){
            axios.patch("http://ec2-3-68-94-147.eu-central-1.compute.amazonaws.com:8000/profile/edit/reset_password/",{
                ...
                <form className="form" action="#" method="POST" onSubmit={(e) => {
                    ...
                    {isFromProfile &&
                        <div className={"block"}>
                            ...
                            <div>
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setErrorPasswordOld(CheckPassword(e.target.value).res)
                                    }}
                                    value={passwordOld}
                            ...
                            <div style={{color: "red"}}>{errorPasswordOld}</div>
                        </div>
                    }
                <div className={"block"}>
                    <div className={"label"}>
